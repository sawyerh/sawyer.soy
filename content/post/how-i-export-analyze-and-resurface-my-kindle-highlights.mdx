...
<MarkdownImage
  url="/uploads/highlight-with-entities.webp"
  caption="A highlight from “Automating Inequality”, showing entities (e.g. Los Angeles) linking to their Wikipedia pages."
  size="prose"
/>
...
<MarkdownImage
  url="/uploads/highlight-book-details.webp"
  caption="Amongst other things, Google Books provides the cover, subtitle, and authors."
  size="prose"
/>
...
![](/uploads/highlight-sms.png "Randomized daily SMS highlights")
